...
class Application
{
    ...
    public function setModules(array $modules)
    {
        ...
        foreach ($modules as $module => $config) {
            ...
            Alias::set(ucfirst($module), Alias::get('Modules.' . ucfirst($module)));
    ...
    protected function getComponentLocator()
    {
     ...
     * @throws Exception
     */
    protected function initAliases(array $config)
    {
     ...
     */
    protected function getDefaultModuleClassNamespace($name)
    {
    ...
    {
        $this->getComponentLocator()->set('translate', Translate::getInstance($this->locale));

        if (php_sapi_name() !== 'cli') {
            $this->getComponentLocator()->get('request');
        }

        foreach ($this->preload as $id) {
            $this->getComponentLocator()->get($id);
        }
    }
    ...
    {
        return $this->getComponent('urlManager')->parseUrl($this->getComponent('request'));
    }
